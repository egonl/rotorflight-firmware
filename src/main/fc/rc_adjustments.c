...
static const adjustmentConfig_t adjustmentConfigs[ADJUSTMENT_FUNCTION_COUNT] =
{
    ...
    ADJ_CONFIG(PITCH_P_GAIN,       PID,   0, 1000),
    ADJ_CONFIG(PITCH_I_GAIN,       PID,   0, 1000),
    ADJ_CONFIG(PITCH_D_GAIN,       PID,   0, 1000),
    ADJ_CONFIG(PITCH_F_GAIN,       PID,   0, 1000),
    ADJ_CONFIG(ROLL_P_GAIN,        PID,   0, 1000),
    ADJ_CONFIG(ROLL_I_GAIN,        PID,   0, 1000),
    ADJ_CONFIG(ROLL_D_GAIN,        PID,   0, 1000),
    ADJ_CONFIG(ROLL_F_GAIN,        PID,   0, 1000),
    ADJ_CONFIG(YAW_P_GAIN,         PID,   0, 1000),
    ADJ_CONFIG(YAW_I_GAIN,         PID,   0, 1000),
